...
define( "RECIPIENT_NAME", "David Ngo" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "dngo11@stanford.edu" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Behavior Design Event Request" ); //UPDATE THIS TO YOUR SUBJECT
